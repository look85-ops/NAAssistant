---
name: impeccable
description: Use when designing, redesigning, auditing, or polishing a frontend interface (websites, landing pages, dashboards, components). Not for backend-only or non-UI tasks.
version: 3.9.1
user-invocable: true
